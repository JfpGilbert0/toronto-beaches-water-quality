...
sns.scatterplot(data=df, x='collectiondate', y='ecoli', hue='beachname', palette='Set1', s=20, alpha=0.7)

# Set title and labels
plt.title('E. coli Levels Over Time by Site and Beach', fontsize=16)
plt.xlabel('Collection Date', fontsize=14)
plt.ylabel('E. coli Level (MPN/100mL)', fontsize=14)
plt.grid(True, axis='x')
# modify x axis labels
plt.xticks(df['collectiondate'][::100], rotation=45)  
plt.tight_layout() 
